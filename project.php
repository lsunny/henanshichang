...
<head>
<meta charset="utf-8">
<title>精品工程 - 河南仕畅市政工程有限公司 - 欢迎您!!! - 联系电话：0396-7636111</title>
...
<div class="container">
    ...
    <div class="conleft fl mr">
     ...
     <div class="engineer fr">
    	<h1 class="engtit"><span class="titmore fr"><a href="./">首页</a> &gt; 精品工程</span>精品工程</h1>
        <div class="zz">
        	<ul>
                 <?php
				 $currpage = isset($_GET['p']) ? $_GET['p'] : 1;
				 $rs  = pager('hnsc_project',$currpage,$f='title,img,id,content',12,$w="flag='y'",'order by id desc');
